...
s:description: Water bodies detection based on NDWI and otsu threshold applied to an Landsat-8/9 acquisition reference.
  ...
  - class: Workflow
    ...
    steps:
      step:
        ...
        doc: Detect water bodies based on the NDWI and otsu threshold from Landsat-8/9 acquisition
        in:
          item: item
          aoi: aoi
          epsg: epsg
